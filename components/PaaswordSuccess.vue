<template>
  <div class="grid lg:grid-cols-2flex-1 justify-center">
    ...
    >
      ...
      <div class="shadow-xl bg-white h-96 w-96 rounded-xl mb-10 mt-3">
        
        <div class="flex justify-center ">
          <hr class="border flex border-blue-500 mt-5">
          <img src="/assets/Image/success.jpg" class="w-24 h-24 mt-5  " alt="" />
        </div>
